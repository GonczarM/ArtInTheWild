...
export interface ApiPhotoPhoto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::photo.photo'> &
      Schema.Attribute.Private;
    mural: Schema.Attribute.Relation<'manyToOne', 'api::mural.mural'> &
      Schema.Attribute.Required;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    favoriteMurals: Schema.Attribute.Relation<'manyToMany', 'api::mural.mural'>;
    likes: Schema.Attribute.Relation<'oneToMany', 'api::like.like'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    murals: Schema.Attribute.Relation<'oneToMany', 'api::mural.mural'>;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
